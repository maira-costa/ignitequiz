...
import { Canvas, Rect, BlurMask } from '@shopify/react-native-skia'; // Anotação: npx expo install @shopify/react-native-skia em https://docs.expo.dev/versions/latest/sdk/skia/
